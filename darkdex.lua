...
local function main()
	...
	Explorer.ShowRightClick = function()
		...
		context:AddDivider()
		context:AddRegistered("FIRE_EVENT")
	...
	Explorer.InitRightClick = function()
		...
		context:Register("FIRE_EVENT",{Name = "Fire Event", IconMap = Explorer.MiscIcons, Icon = "Group", DisabledIcon = "Group_Disabled", Shortcut = "Ctrl+G", OnClick = function()
			local sList = selection.List
			if #sList == 0 then return end

			for i = 1,#sList do
				sList[i].Obj:FireServer()
			end
		end})
...
Main = (function()
	...
	Main.Init = function()
		...
		Main.MiscIcons:SetDict({
			...
			Delete = 7,                Delete_Disabled = 8,             Fire_Event = 9,             Group_Disabled = 10,    Ungroup = 11,         Ungroup_Disabled = 12,    TeleportTo = 13,
